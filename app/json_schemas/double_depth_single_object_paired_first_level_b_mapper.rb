...
Node Path: root->athlete_part_3->athlete_part_2
{"school_id"=>"root_B_athlete_part_3_B_athlete_part_2_P_school_id"}
...
=end
class DoubleDepthSingleObjectPairedFirstLevelBMapper < Superstudio::SqlJsonBuilder
  def map_row
    @json_nodes[:root_B_athlete_part_3_B_athlete_part_2_P_school_id] = value_by_column_name("school_id")
