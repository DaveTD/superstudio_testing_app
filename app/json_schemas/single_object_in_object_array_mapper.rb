...
{"name"=>"root_B_schools_B_school_properties_P_name",
 "country"=>"root_B_schools_B_school_properties_P_country"}
...
=end
class SingleObjectInObjectArrayMapper < Superstudio::SqlJsonBuilder
  def map_row
    @json_nodes[:root_B_schools_B_school_properties_P_name] = value_by_column_name("name")
    @json_nodes[:root_B_schools_B_school_properties_P_country] = value_by_column_name("country")
