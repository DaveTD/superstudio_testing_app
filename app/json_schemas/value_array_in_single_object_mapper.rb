...
Node Path: root->school_details->student_ids
{"items"=>"root_B_school_details_B_student_ids_A_items"}
...
{"id"=>"root_P_id"}
=end
class ValueArrayInSingleObjectMapper < Superstudio::SqlJsonBuilder
  def map_row
    @json_nodes[:root_B_school_details_B_student_ids_A_items] = value_by_column_name("athlete_id")
